...
{{
var G__12413 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12413;
continue;
}
} else
...
{var pred__12417 = cljs.core._EQ_;var expr__12418 = limit;if(cljs.core.truth_(pred__12417.call(null,1,expr__12418)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12417.call(null,2,expr__12418)))
...
var G__12420 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12421 = (limit__$1 - 1);
var G__12422 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12420;
limit__$1 = G__12421;
parts = G__12422;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12424 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12424))
{var replacement_12425 = temp__4090__auto___12424;buffer.append([cljs.core.str(replacement_12425)].join(''));
} else
{buffer.append(ch);
}
{
var G__12426 = (index + 1);
index = G__12426;
continue;
}
}
