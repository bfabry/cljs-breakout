...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11999 = 0;while(true){
var m_12000 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12000 == null))
{} else
{m_12000.call(null);
if((count_11999 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12001 = (count_11999 + 1);
count_11999 = G__12001;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3370__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3370__auto__)
