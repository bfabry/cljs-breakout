...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3926__auto__,writer__3927__auto__,opt__3928__auto__){return cljs.core._write.call(null,writer__3927__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_11964 = 0;while(true){
if((i_11964 < arr.length))
{(arr[i_11964] = null);
{
var G__11965 = (i_11964 + 1);
i_11964 = G__11965;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3926__auto__,writer__3927__auto__,opt__3928__auto__){return cljs.core._write.call(null,writer__3927__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_11971 = (self__.level + 1);while(true){
if((i_11971 <= (new_level + 1)))
{(update[i_11971] = self__.header);
{
var G__11972 = (i_11971 + 1);
i_11971 = G__11972;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_11973 = 0;while(true){
if((i_11973 <= self__.level))
{var links_11974 = (update[i_11973]).forward;if(((links_11974[i_11973]) === x__$1))
{(links_11974[i_11973] = (x__$1.forward[i_11973]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3382__auto__ = (cljs.core.truth_((function (){var and__3370__auto__ = me;if(cljs.core.truth_(and__3370__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3370__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3382__auto__))
