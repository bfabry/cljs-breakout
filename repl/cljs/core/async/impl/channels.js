...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12005 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12005 = (function (val,box,meta12006){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12005.cljs$lang$type = true;
cljs.core.async.impl.channels.t12005.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12005";
cljs.core.async.impl.channels.t12005.cljs$lang$ctorPrWriter = (function (this__3926__auto__,writer__3927__auto__,opt__3928__auto__){return cljs.core._write.call(null,writer__3927__auto__,"cljs.core.async.impl.channels/t12005");
});
cljs.core.async.impl.channels.t12005.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12005.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12007){var self__ = this;
var _12007__$1 = this;return self__.meta12006;
});
cljs.core.async.impl.channels.t12005.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12007,meta12006__$1){var self__ = this;
var _12007__$1 = this;return (new cljs.core.async.impl.channels.t12005(self__.val,self__.box,meta12006__$1));
});
cljs.core.async.impl.channels.__GT_t12005 = (function __GT_t12005(val__$1,box__$1,meta12006){return (new cljs.core.async.impl.channels.t12005(val__$1,box__$1,meta12006));
});
}
return (new cljs.core.async.impl.channels.t12005(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3929__auto__,writer__3930__auto__,opts__3931__auto__){return cljs.core._write.call(null,writer__3930__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3926__auto__,writer__3927__auto__,opt__3928__auto__){return cljs.core._write.call(null,writer__3927__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_12008 = self__.takes.pop();if((taker_12008 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12008))
{var take_cb_12009 = cljs.core.async.impl.protocols.commit.call(null,taker_12008);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12009,taker_12008){
return (function (){return take_cb_12009.call(null,null);
});})(take_cb_12009,taker_12008))
);
} else
{}
{
